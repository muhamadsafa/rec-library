...
// Ambil nilai idmot dari parameter URL
$idmot = $_GET['id'];

// Query untuk mengambil data motivasi berdasarkan idmot
$query = "SELECT * FROM motivasi WHERE idmot = $idmot";
$result = mysqli_query($conn, $query);
$row = mysqli_fetch_assoc($result);

// Tampilkan data motivasi lengkap
?>
<div class="container">
    <h1><?php echo $row['jumot']; ?></h1>
    <p><?php echo $row['cermot']; ?></p>
    <a href="javascript:history.go(-1)">Kembali</a>
</div>

<div class="container-dalneg">
    <a href="posting_selengkapnya.php?id=<?php echo $idmot; ?>">Selengkapnya</a>
</div>
</body>
