...
<html lang="en">
 ...
 <?php
    ...
    <div class="container pt-5 pb-5">
        <strong>Q: Apa itu Rec Library?</strong>
        <p>A: Rec Library adalah sebuah website perpustakaan digital yang dapat memberikan rekomendasi buku dengan menggunakan Algoritma Apriori.</p>
        <strong>Q: Bagaimana cara mendapatkan rekomendasi buku?</strong>
        <p>A:  Cara mendapatkan rekomendasi buku yaitu user perlu login terlebih dahulu, kemudian rekomendasi buku akan muncul mengikuti dengan banyak pencarian pada jenis buku yang sama yang telah dicari sebelumnya.</p>
    <strong>Q: Bagaimana cara mendapatkan akun pengguna?</strong>
        <p>A: Cara mendapatkan akun pengguna yaitu dengan menghubungi nomor WhatsApp admin yang tertera terlebih dahulu, kemudian admin akan membuatkan akun untuk pengguna untuk menjaga keamanan data .</p>
