...
<body>
    ...
    <div class="container pt-5 pb-5">
        <strong>Q: Bagaimana cara mengunggah program beasiswa bagi penyelenggara?</strong>
        <p>A: Penyelenggara dapat melakukan login terlebih dahulu kemudian memilih menu unggah beasiswa.</p>
        <strong>Q: Apa kegunaan forum diskusi ISB?</strong>
        <p>A: Kegunaan forum diskusi ISB adalah untuk mewadahi seluruh sobat ISB yang sedang mencari beasiswa untuk studi lanjutnya sehingga dapat berbagi informasi satu sama lain.</p>
    </div>
