...
<body>
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark shadow-lg fixed-top">
        ...
        </i>&ensp;CARA REGISTRASI</a>
    </div>
    <div class="container text-center pt-5 pb-2">
        <h2>Cara Mendapatkan Akun ISB</h2>
    </div>
    <div class="container pt-5 pb-5">
        <ol class="mb-4">
        <li class="mb-2" style="font-size: large;"> Pastikan Anda memiliki program beasiswa yang akan dibuka atau masih berlaku</li> 
        <li class="mb-2" style="font-size: large;"> Kunjungi website ISB.Pelajar.com</li>
        <li class="mb-2" style="font-size: large;"> Hubungi email <strong> Bantuan.ISB@gmail.com</strong></li>
        <li style="font-size: large;"> Kirim email menggunakan akun lembaga berupa permintaan akses unggah beasiswa pada website ISB dengan subject Unggah Beasiswa dan format sebagai berikut :</li> 
        <ul class="mb-2">
            <li>Lembaga penyelenggara :</li>
            <li>Nomor telepon :</li>
            <li>Alamat lembaga :</li>
            <li>Nama program beasiswa :</li>
            <li>Poster beasiswa :</li>
            <li>Link website program beasiswa :</li>
        </ul>
        <li class="mb-2" style="font-size: large;"> Tunggu balasan email dalam 2x24 jam</li>
        <li class="mb-2" style="font-size: large;"> Dalam waktu tersebut, Anda akan mendapat balasan email berupa password untuk login pada website ISB</li>
    </ol>
    </div>
</body>
