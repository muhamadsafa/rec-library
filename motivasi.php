...
$query = "SELECT promot, jumot, cermot FROM motivasi";
...
<div class="container-dalneg pb-3">
        <img class="kiri" src="Asset/profil/<?php echo $promot; ?>" width="100" height="100" />
            <h5><?php echo $jumot; ?></h5>
            <p><?php echo $cermot; ?></p>
            <?php if ($promot === $_SESSION['profile']) { ?>
                <div class="btn-group" role="group">
                    <a href="edit_postingan.php?id=<?php echo $idmot; ?>" class="btn btn-primary">Edit</a>
                    <a href="hapus_postingan.php?id=<?php echo $idmot; ?>" class="btn btn-danger">Hapus</a>
                    <br/>
                </div>
            <?php } ?>
    </div>
