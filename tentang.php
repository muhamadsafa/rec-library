...
<body>
    ...
    <div class="container pt-5 pb-5">
        <p>Informasi Seputar Beasiswa (ISB) merupakan sebuah website yang berupa penyedia informasi dari banyaknya program beasiswa bagi pelajar Indonesia. </p>
        <p>Informasi Seputar Beasiswa (ISB) ini dipersiapkan bagi mahasiswa yang akan studi lanjut baik di dalam negeri maupun di luar negeri.</p>
        <p>Informasi Seputar Beasiswa (ISB) juga mewadahi para penyelenggara beasiswa untuk mempromosikan program beasiswanya kepada pelajar Indonesia.</p>
        <p>Terkait dengan hal itu, jikalau ada pihak atau penyelenggara beasiswa dalam negeri atau luar negeri ingin mengunggah programnya pada website Informasi Seputar Beasiswa (ISB) dapat login terlebih dahulu dan mengisi beberapa persyaratan pada halaman unggah beasiswa. Persyaratan yang dibutuhkan yaitu berupa tanggal beasiswa akan dibuka dan juga tanggal beasiswa akan ditutup, poster beasiswa yang ingin di ajukan, dan lain sebagainya.</p>
        <p>Selain itu, jika penyelenggara beasiswa sudah memenuhi persyaratan dan berhasil untuk upload program beasiswa juga dapat mengunggah motivasi untuk meraih program beasiswa.</p><br><br>
        <p>Dan jika ingin bertanya dan berdiskusi dengan kami lebih lanjut silahkan menghubungi kami pada beberapa kontak di bawah ini.</p>
    </div>
