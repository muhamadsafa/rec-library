...
<body>
    ...
    <div class="container pt-5 pb-3">
        <h2>Join with us!</h2>
        <p>Informasi Seputar Beasiswa (ISB) merupakan penyedia informasi beasiswa bagi pelajar Indonesia untuk mempersiapkan studi lanjut baik di dalam negeri maupun di luar negeri. Tidak hanya melalui website saja namun ISB juga memiliki grup forum yang dapat kita gunakan sebagai tempat untuk mencari informasi seputar beasiswa dan juga berdiskusi mengenai beasiswa.</p><br>
        <p><a href="https://chat.whatsapp.com/DN7egZj4tsYCe3j4P2c1j0" target="_blank">
  <button type="button" class="btn-outline-success btn-sm" style="width: 450px;">
    <i class="fa fa-whatsapp float-left fa-4x mr-4 ml-4"></i>
    <h2>WhatsApp</h2>
    <p>Gabung bersama kami melalui grup WhatsApp</p>
  </button>
</a></a>&emsp;
        <a href="https://t.me/+jfjXdrI-RV9hY2Jl" target="_blank">
  <button type="button" class="btn-outline-primary btn-sm" style="width: 450px;">
    <i class="fa fa-telegram float-left fa-4x mr-4 ml-4"></i>
    <h2>Telegram</h2>
    <p>Gabung bersama kami melalui grup Telegram</p>
  </button>
</a>
        </p>
    </div>
