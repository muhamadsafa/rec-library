  ...
  <body>
    ...
    <div class="container-fluid banner">
      <div class="container text-center">
        <h4 class="display-6 wetek">Selamat Datang di Website Kami</h4>
        <h3 class="display-5 wetek">INFORMASI SEPUTAR BEASISWA</h3>
        <a href="#tentang"> </a>
      </div>
    </div>
    <div class="container-fluid layanan pt-5 pb-7">
      <div class="container text-center">
        <h2 class="display-5" id="layanan">APA YANG KAMU BUTUHKAN?</h2>
        <br />
        <a href="#tentang"> </a>
