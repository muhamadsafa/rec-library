      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="mynavbar">
          <ul class="navbar-nav me-auto m-sm-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="book.php">Dataset Buku</a>
            </li>
            <li class="nav-item">
        ...
        </i>&ensp; Pencarian Buku</a>
    </div>
    
    
      <div class="container text-center">
        <h3 class="display-5 wetek">Rec-Library</h3>
        <a href="#tentang"> </a>
      </div>
...
<form action="" method="post">
    <div class="row mt-3">
        ...
        <div class="col-sm-2">
            <button class="btn btn-success" type="button" id="search" name="search">Cari</button>
        </div>
    </div>
</form>
    <br>
...
<div class="container-dalneg pb-3">
        ...
        <p> Author : <?php echo $author; ?>&nbsp;<a class="linkis" href="becend.php?id=<?php echo $isbn; ?>">Info Selengkapnya</a></p>
        <br/>
        </div>
